...
class DataService{
    ...
    func getUserOfID(userID:String,handler: @escaping(_ success:Bool,_ user:User?)->()){
        ...
        userRef.getDocument { (document, error) in
            if let document = document, document.exists {
                ...
                let user = User(id: id, name: name, email: email, image: image, gender: gender, country: country, region: region)
